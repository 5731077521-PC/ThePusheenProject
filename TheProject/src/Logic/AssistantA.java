...
public class AssistantA extends JComponent implements IRenderable,Pusheen{
	...
	public AssistantA(int x,int y,int speed){
		counter = 0;
		this.x = x;
		this.y = y;
		this.speed = speed;
	...
	public boolean isCollideWith(Bullet b){
	 ...
	 public void paintComponent(Graphics2D g) {
	       ...
	       // if(direction<0) 
	        Resource.assistantA_left.paintIcon(this, g, x, y);
	        	//else
	        // Resource.assistantA_right.paintIcon(this, g, x, y);
